...
if __name__ == "__main__":
    ...
    param_set.add_parameters(sparse_start_after=[0])
    ...
    param_set.add_parameters(sparse_data_rate=[0.5])
    param_set.add_parameters(sparse_data_max=[0.75])
    ...
    param_set.add_parameters(weights_minimum=[0.5])
    ...
    experiment = Experiment("tutw-debug", constrained, make_build_fn(**env_params))
