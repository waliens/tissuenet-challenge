...
def main(argv):
    ...
    results_path = os.path.join("/home", "rmormont", "clustertools_data", "exp_segpc-unet-hard", "results")
    ...
    experiment = Experiment("segpc-reeval-hard", param_set, make_build_fn(**env_params))
