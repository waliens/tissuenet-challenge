...
if __name__ == "__main__":
    ...
    param_set.add_parameters(sparse_start_after=[30])
    ...
    param_set.add_parameters(lr_sched_cooldown=[3])
    param_set.add_parameters(save_cues=[False])
    # param_set.add_separator()
    # param_set.add_parameters(sparse_start_after=[-1, 0, 5, 10])
    # param_set.add_parameters(loss=["both", "dice"])
